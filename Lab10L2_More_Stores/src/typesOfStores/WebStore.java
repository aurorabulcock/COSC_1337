...
/**Encapsulates information for a WebStore. Extends Store.<hr>.
 * Contains both a url and a programming language.
 */
public class WebStore extends Store {
	...
	public WebStore(String name, String address, String url, String programmingLanguage) {
		//calls the super constructor then sets url and programmingLanguage
		super(name, address);
		setUrl(url);
