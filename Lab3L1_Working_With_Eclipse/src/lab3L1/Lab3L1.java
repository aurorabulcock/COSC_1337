 ...
 * Insight: Because the warOf1812Starts and theForgottenWarStarts reference the same object.
 * */
package lab3L1;
...
public class Lab3L1 {
	...
	public static void main(String[] args) {
		...
		//theForgottenWarStarts and warOf1812Starts are referencing the 
		//same object (the date of 6/17/1812)
		...
		//You can also do System.out.println(teddyBearDebut.toString()); 
